...
from ..history import PRICE_WINDOW_MONTHS as HISTORY_PRICE_WINDOW_MONTHS
...
#: Окно, из которого берётся цена предложения. Одно на всю систему —
#: `history.PRICE_WINDOW_MONTHS`, см. там объяснение, почему оно там (П-8).
#: Здесь окно ИСКЛЮЧАЕТ: 8.3 обещает экономию, а обещать её по цене двухлетней
#: давности — то же самое, что выдавать за цену число, похожее на цену (Р-21).
PRICE_WINDOW_MONTHS = HISTORY_PRICE_WINDOW_MONTHS
